...
def main():
    try:
        ...
        if log_data:
            ...
            print(f'There are {len(log_data)} suspicious packets have been recorded')
            print(f'Logs have been saved in the "{os.path.abspath("logs")}" folder')
        else:
